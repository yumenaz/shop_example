...
RSpec.describe Category, :type => :model do
  describe "Valid" do
  	it { expect(Category.new(name: "Ruby on Rails", level: "")).to be_valid }
  	it { expect(Category.new(name: "Ruby & on & Rails", level: "2")).to be_valid }
  end
  ...
  describe "Invalid" do
    ...
    it { expect(Category.new(name: "Ruby on Rails", level:"ruby")).not_to be_valid  }
